...
const suggestion = computed(() =>
  suggestions.value.find((s: Suggestion) => s.id === route.params.id)
)
...
async function onAccept() {
  if (suggestion.value && seed.value) {
    ...
    seed.value.description =
      descriptionCheck.value && sugg.description ? sugg.description : seed.value.description
    ...
    seed.value.sfgOriginal =
      sfgOriginalCheck.value && sugg.sfgOriginal ? sugg.sfgOriginal : seed.value.sfgOriginal
    seed.value.sfgMultisow =
      sfgMultisowCheck.value && sugg.sfgMultisow ? sugg.sfgMultisow : seed.value.sfgMultisow
    seed.value.sfgClump = sfgClumpCheck.value && sugg.sfgClump ? sugg.sfgClump : seed.value.sfgClump
    seed.value.germinationMin =
      germinationMinCheck.value && sugg.germinationMin !== null
        ? sugg.germinationMin
        : seed.value.germinationMin
    seed.value.germinationMax =
      germinationMaxCheck.value && sugg.germinationMax !== null
        ? sugg.germinationMax
        : seed.value.germinationMax
    ...
    <section v-if="suggestion && seed">
      <table class="table">
        ...
        <tbody>
            ...
            <td>
              <div class="form-check">
                <input
                  ...
                  value=""
                  id="speciesCheck"
                  v-model="speciesCheck"
                />
                <label
                  class="form-check-label"
                  :class="{ 'text-success': speciesCheck }"
                  for="speciesCheck"
                >
          ...
          <tr v-if="suggestion.description">
            ...
            <td>
              <div class="form-check">
                ...
                <label
                  class="form-check-label"
                  :class="{ 'text-success': descriptionCheck }"
                  for="descriptionCheck"
                >
          ...
          <tr v-if="suggestion.sentOn">
            ...
            <td>
              <div class="form-check">
                ...
                <label
                  class="form-check-label"
                  :class="{ 'text-success': sentOnCheck }"
                  for="sentOnCheck"
                >
          ...
          <tr v-if="suggestion.tags">
            ...
            <td>
              <TagBadge v-for="(tag, i) in toTags(suggestion.tags)" :key="i" :tag="tag" />
            </td>
            <td>
              <div class="form-check">
                <input
          ...
          <tr v-if="suggestion.family">
            ...
            <td>
              <div class="form-check">
                ...
                <label
                  class="form-check-label"
                  :class="{ 'text-success': familyCheck }"
                  for="familyCheck"
                >
            ...
            <td>
              <div class="form-check">
                <input
                  ...
                  value=""
                  id="sfgOriginalCheck"
                  v-model="sfgOriginalCheck"
                />
                <label
                  class="form-check-label"
                  :class="{ 'text-success': sfgOriginalCheck }"
                  for="sfgOriginalCheck"
                >
            ...
            <td>
              <div class="form-check">
                <input
                  ...
                  value=""
                  id="sfgMultisowCheck"
                  v-model="sfgMultisowCheck"
                />
                <label
                  class="form-check-label"
                  :class="{ 'text-success': sfgMultisowCheck }"
                  for="sfgMultisowCheck"
                >
            ...
            <td>
              <div class="form-check">
                <input
                  ...
                  value=""
                  id="sfgClumpCheck"
                  v-model="sfgClumpCheck"
                />
                <label
                  class="form-check-label"
                  :class="{ 'text-success': sfgClumpCheck }"
                  for="sfgClumpCheck"
                >
            ...
            <td>
              <div class="form-check">
                <input
                  ...
                  type="checkbox"
                  value=""
                  id="germinationMinCheck"
                  v-model="germinationMinCheck"
                />
                <label
                  class="form-check-label"
                  :class="{ 'text-success': sfgClumpCheck }"
                  for="germinationMinCheck"
                >
            ...
            <td>
              <div class="form-check">
                <input
                  ...
                  type="checkbox"
                  value=""
                  id="germinationMaxCheck"
                  v-model="germinationMaxCheck"
                />
                <label
                  class="form-check-label"
                  :class="{ 'text-success': sfgClumpCheck }"
                  for="germinationMaxCheck"
                >
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        ...
        <button
          ...
          data-bs-target="#suggestionRejectModal"
        >
