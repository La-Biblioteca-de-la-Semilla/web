...
<template>
  <section class="container">
    ...
    <small class="text-muted">
      Bienvenid@ a la zona de intercambio, también conocida como "el mercadillo". Aquí tienes una
      forma de intercambiar semillas con los demás usuarios de la biblioteca. Esta herramienta cruza
      los datos de las semillas que tienes y las que quieres, con las que tiene y quiere el resto de
      usuarios y te muestra la siguiente lista con los que mas puedes intercambiar:
    </small>
    ...
    <div class="row mt-4" v-else-if="matches.length > 0">
      <div class="col-md-4 mb-3" v-for="(m, i) in matches" :key="i">
        <div class="card">
          ...
          <div class="card-body">
            <RouterLink :to="{ name: 'user-detail', params: { id: m.id } }" class="card-link"
    ...
    <div v-else class="text-center mt-5">
      ...
      <p class="text-muted">
        <i class="bi bi-exclamation-circle-fill" /> Para poder usar la zona de intercambio necesitas
        marcar algunas semillas como las que tienes o las que quieres en la
