        ...
        <div class="ms-2 me-auto">
          <div class="fw-bold">
            <RouterLink
              ...
              :to="{ name: 'suggestion-detail', params: { id: suggestion.id } }"
            >
              {{ suggestion.name }}
            </RouterLink>
          </div>
          <small class="text-muted">
            <i class="bi bi-bandaid" /> {{ getDiffNum(suggestion) }} cambios por
            {{ suggestion.userId }} <i class="bi bi-calendar-check ms-3" />
