...
function onAction(action: string, isSubmit: boolean) {
  if (isSubmit) {
    ...
    ;[seedNameBlurred.value, seedScientificNameBlurred.value, seedImageBlurred.value] = [
      true,
      true,
      true
    ]
    ...
    <div class="row">
      <div class="col-md-3 p-0" v-if="model.image.length <= 0">
        ...
        <div
          ...
          :class="{ 'd-block': isEmpty(model.image) && seedImageBlurred }"
        >
      ...
      <div class="col-md-9">
        <div class="mb-4">
          ...
          <input
            ...
            v-model="model.name"
          />
          <div class="invalid-feedback">Introduce el nombre común de la semilla.</div>
        </div>
        ...
        <div class="mb-4">
          ...
          />
          <div class="invalid-feedback">Introduce un nombre científico para la semilla.</div>
        </div>
        ...
        <div class="mb-4">
          ...
          <input
            ...
            class="form-control"
            id="seedSentOnName"
            placeholder="Fecha o paquete de envío"
    ...
    <div class="row my-4">
      <div class="col-md-6">
        ...
        <div class="mb-4">
          ...
          <p>
            <TagCheckButton v-for="(tag, i) in TAGS" :key="i" :tag="tag" v-model="model.tags" />
          </p>
        </div>
        <div class="mb-4">
          ...
          <div class="input-group mb-3">
            ...
            <input
              ...
              class="form-control"
              placeholder="Mínimo"
              aria-label="germinationMin"
              aria-describedby="germinationTemperature"
              v-model="model.germinationMin"
            />
            <input
              type="number"
              class="form-control"
              placeholder="Máximo"
              aria-label="germinationMax"
              aria-describedby="germinationTemperature"
              v-model="model.germinationMax"
            />
          </div>
        </div>
      </div>
      ...
      <div class="col">
        <div class="mb-4">
          ...
          <textarea
            ...
            id="seedDescripton"
            rows="5"
            placeholder="Escribe una descripción: origen, usos, curiosidades, etc."
          ></textarea>
        </div>
      </div>
    </div>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        <template v-if="!isSubmitting">
          <button
            ...
            :key="i"
            @click.prevent="onAction(b.action, b.isSubmit)"
            :class="b.class"
          >
            {{ b.text }}
          </button>
